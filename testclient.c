...
int main(int argc, char *argv[])
{
	...
	if (pid == 0){
		...
		inet_pton(AF_INET6, "2001:0:c38c:c38c:c3:22d1:503f:828", &server_addr.sin6_addr);
		...
		printf("process2: Received %c from server\n", ch);
		...
		printf("parent socket connected!\n");
		...
		printf("process1: Received %c from server\n", ch);
